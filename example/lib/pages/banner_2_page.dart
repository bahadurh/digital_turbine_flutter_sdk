...
import '../adaptive_ad_banner_v2.dart';
...
class _Banner2PageState extends State<Banner2Page> {
  late final DigitalTurbineBannerController _controller;
  ...
  void initState() {
    super.initState();
    _controller = DigitalTurbineBannerController(onAdLoaded: _onAdLoaded, placementId: widget.placementId);
  }
      ...
      Column(
        children: [
          SizedBox(
            height: 250,
            width: 300,
            child: DigitalTurbineBannerView(
